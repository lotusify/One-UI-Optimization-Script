...
@echo Removing some extra devs option
...
@echo Uninstalling Meta/Facebook crap
...
@echo Uninstalling Google Bloatware
...
adb shell pm uninstall --user 0 com.android.chrome                                      #Chrome

@echo Removing Edge related apps except Split Screen
...
@echo Removing some knox-related apps
...
@echo Removing 3rd party related app and downloader
...
adb shell pm uninstall --user 0 com.opera.max.oem                                       #Samsung VPN and Data Saver
...
adb shell pm uninstall --user 0 com.eterno.shortvideos                                  #Facebook app installer
...
adb shell pm uninstall --user 0 com.samsung.android.themecenter                         #Galaxy Theme Service
adb shell pm uninstall --user 0 com.samsung.android.themestore                          #Galaxy Theme Store
...
adb shell pm uninstall --user 0 com.samsung.android.rubin.app      #Customization Service
adb shell pm uninstall --user 0 com.samsung.android.mobileservice                       #Group Sharing
adb shell pm uninstall --user 0 com.samsung.android.mdx       #Link to Windows Services
adb shell pm uninstall --user 0 com.samsung.android.mdx.kit     #Mdx kit service
...
adb shell pm uninstall --user 0 com.samsung.ecomm.global.in    #Samsung Shop
adb shell pm uninstall --user 0 com.samsung.sree    #Samsung Global Goal
...
adb shell pm uninstall --user 0 com.samsung.android.alive.service                       #Device Customization Service
adb shell pm uninstall --user 0 com.samsung.android.aware.service                       #Quick Share
adb shell pm uninstall --user 0 com.mygalaxy                                            #My Galaxy
adb shell pm uninstall --user 0 com.samsung.SMT                                         #Samsung TTS


@echo Debloating Samsung crap
...
adb shell pm uninstall --user 0 com.samsung.aasaservice     #AASA Services                            #AASA service
adb shell pm uninstall --user 0 com.samsung.android.accessibility.talkback   #TalkBack
...
adb shell pm uninstall --user 0 com.samsung.memorysaver    #Storage Saver
adb shell pm uninstall --user 0 com.samsung.android.visualars   #Samsung Smart Touch Call
...
@echo Debloating ARZone related apps
...
@echo Debloating Game Launcher, Game Tools and Game Booster
...
@echo Debloating AOSP bloatware
...
@echo Debloating Wifi Calling related apps
...
adb shell pm uninstall --user 0 com.samsung.android.uds                                 #Ultra Data Saving modeecho Completed Action

set /p reboot=Do u want to reboot your device now (y/n)?
if /i "%reboot%" equ "y" adb reboot & echo Rebooting
if /i "%reboot%" equ "n" echo Please reboot later
echo Now you can enjoy faster experience never like before
